...
### 4a. Privacy Policy ko public website pe daalo

Play Store ko Privacy Policy ka ek **public internet link** chahiye hota hai (sirf app ke andar hona kaafi nahi hai). Sabse aasan free tarika:

1. Firebase Console → tumhare project (`bharatmitra-ai`) me **Hosting** section me jao → "Get Started"
2. Terminal access na ho to koi dost/tool se `firebase deploy` karwa lo, ya simplest: `www/privacy-policy.html` aur `www/terms.html` ko kisi bhi free static host pe daal do (Firebase Hosting, Netlify, ya GitHub Pages — sabse aasan **GitHub Pages** hai: tumhare hi GitHub repo → Settings → Pages → Deploy from branch → `main` → root — kuch minute me `https://falcontechh.github.io/bharatmitra-android/privacy-policy.html` jaisa live link mil jayega)
3. Wo live link Play Console ke "Privacy Policy URL" field me daalna hoga (Step 4c me)

### 4b. Release Signing Key (bahut zaroori — sambhal ke rakhna)
...
### 4c. CodeMagic me signing secrets add karo
...
### 4e. Play Console pe submit karo
